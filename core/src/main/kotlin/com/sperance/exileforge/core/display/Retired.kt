...
/**
 * Mana and spells left the game in 2.48.0 (server 0.43.0, `RETIRED_STATS` there): no fight casts, no pool rolls them any more, and the client shows none of it — not on the sheet, not on a monster,
