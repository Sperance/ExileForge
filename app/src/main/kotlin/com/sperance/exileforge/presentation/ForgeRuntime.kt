...
class ForgeRuntime(val store: ServerStore, val journal: RequestJournal) {
    ...
    fun clearSession() {
        ...
        mutable.update { it.copy(passiveTree = null, passiveState = null, passivePending = null, passiveCharacterId = "", combatCatalog = null, battleView = null, battlePending = null, battleCharacterId = "", battleAction = null, battleLoot = emptyMap(), signedIn = false, profile = null, sessionEpoch = it.sessionEpoch + 1, items = emptyList(), total = 0, page = 0, totalPages = 0,
