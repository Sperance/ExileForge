...
class ForgeViewModel(store: ServerStore, journal: RequestJournal, deviceId: String) : ViewModel() {
    ...
    fun openMapServices(mapCode: String) = runtime.expeditionViewModel.openMapServices(mapCode)
    fun closeMapServices() = runtime.expeditionViewModel.closeMapServices()
