        ...
        task(writing = true) {
            ...
            try {
                ...
                mutable.update { it.copy(passivePending = null, passiveState = result, passiveCharacterId = pending.characterId,
                    inventoryVersion = null, inventoryNext = null, inventoryTotal = 0, itemTotals = emptyMap(), equipmentView = null, comparison = null, craftOptions = null, battleView = null, battleCharacterId = "", battleAction = null) }
            } catch(e: ApiFailure) {
